...
class OrganizacaoBaixas():
    ...
    def org_baixas(self):
        ...
        ttk.Label(resumo_frame, text=f"Número do Processo: {self.numero_processo_recebido or 'Não informado'}", foreground='black', font=("Inconsolata", 12, "bold")).pack(anchor="w")
